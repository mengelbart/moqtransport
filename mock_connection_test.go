...
//
//	mockgen -typed -write_package_comment=false -package moqtransport -self_package github.com/mengelbart/moqtransport -destination mock_connection_test.go github.com/mengelbart/moqtransport Connection
//
...
func (m *MockConnection) ApplicationProtocol() ApplicationProtocol {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplicationProtocol")
	ret0, _ := ret[0].(ApplicationProtocol)
	return ret0
}
...
// Return rewrite *gomock.Call.Return
func (c *MockConnectionApplicationProtocolCall) Return(arg0 ApplicationProtocol) *MockConnectionApplicationProtocolCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockConnectionApplicationProtocolCall) Do(f func() ApplicationProtocol) *MockConnectionApplicationProtocolCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockConnectionApplicationProtocolCall) DoAndReturn(f func() ApplicationProtocol) *MockConnectionApplicationProtocolCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
